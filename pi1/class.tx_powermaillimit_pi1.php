...
class tx_powermaillimit_pi1 extends tslib_pibase {
	...
	function PM_MandatoryHookBefore(&$error, $markerArray, &$sessionfields, $obj) {
		$this->obj = $obj;
	...
	function isLimitExceeded($fieldUid, $option) {
	...
	function countStoredMailField($fieldUid, $value) {
	...
	function isPostLimitExceeded(&$obj) {
